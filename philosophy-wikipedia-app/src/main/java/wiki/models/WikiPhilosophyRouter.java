...
import wiki.models.common.contracts.IEntity;
...
public class WikiPhilosophyRouter implements IEntity<Long>, Serializable {
	...
	@NotNull
	public static Article sourceArticle;

	@ManyToOne
	@JoinColumn(name = "destination_article_id")
	@NotNull
	public static Article destinationArticle;
	...
	public void computePath() throws IOException {
		...
		totalHops = visitedArticles.size() - 1;
	}
